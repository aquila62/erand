...
int main(void)
   ...
   while (i--)
      {
      int indx;
      indx = (erand(er) >> 28) & 7;      /* 3 bit sample 0-7 */
   ...
   while (i--)
      {
      int indx;
      indx = (erand(er) >> 24) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (erand(er) >> 20) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (erand(er) >> 16) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (erand(er) >> 12) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (erand(er) >> 8) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = (erand(er) >> 4) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
   ...
   while (i--)
      {
      int indx;
      indx = erand(er) & 15;      /* 4 bit sample 0-15 */
      tally[indx] += 1.0;        /* tally the sample */
      } /* for each sample */
   /******************************************/
   /* add up the chi square from 16 counters */
