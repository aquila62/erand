/************************************************************************/
/* erandencr.c  Version 1.0.0                                           */
/* Encrypt an input stream with the erand algorithm                     */
...
/**********************************************************/
/* This program initializes the erand random number       */
...
/* Once initialized with RANDU, erand is warmed up        */
...
int main(int argc, char **argv)
   ...
   unsigned int *statep;       /* pointer into er->state */
   unsigned int *stateq;       /* pointer for end of er->state */
   unsigned char psw[128];     /* password text */
   unsigned char *buf;         /* input/output buffer */
   erfmt *er;                  /* erand RNG structure */
   ...
   er->prev  = RAND;
   er->pprev = RAND;
   statep = (unsigned int *) er->state;
   stateq = (unsigned int *) er->state + 1024;
   while (statep < stateq)
      {
      *statep++ = RAND;
      } /* for each state in er->state array */
   /*****************************************************/
   /* warm up the erand random number generator         */
   /*****************************************************/
   i = 2048;
   while (i--) erand(er);
   /*****************************************************/
