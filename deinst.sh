...
make -f erandchi.mak clean
make -f eranddots.mak clean
make -f erandencr.mak clean
make -f erandgen.mak clean
make -f erandnorm.mak clean
make -f erandpat.mak clean
make -f erandraw.mak clean
make -f erandtim.mak clean
make -f fcdeal.mak clean
