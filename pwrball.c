...
int main()
   ...
   char maindraw[128];
   char bonuspool[64];
   er = (erfmt *) erandinit();   /* initialize erand generator */
   ...
   *p = 1;
   ...
   free(er->state);    /* free state array */
   free(er);           /* free erand structure */
   return(0);          /* normal eoj */
   } /* main */
