/* erandnorm.c - erand Gaussian distribution Version 1.0.0           */
...
void boxmul(erfmt *er, double mean,
...
int main(int argc, char **argv)
   ...
   er = (erfmt *) erandinit();   /* initialize erand to date/time */
   ...
   while (i--)
      {
      boxmul(er,mean,stdev,aa);        /* Box-Muller Transform */
